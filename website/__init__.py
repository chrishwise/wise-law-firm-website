...
def create_app():
    ...
    databaseURL = f"postgresql://{os.environ.get('RDS_USERNAME')}:{os.environ.get('RDS_PASSWORD')}@{os.environ.get('RDS_HOSTNAME')}:{os.environ.get('RDS_PORT')}/awseb-e-s4fjj93nzr-stack-awsebrdsdatabase-x1cayjrpdghl"
